...
if(size1%2==0){
    ...
    if(size1==2){
            if((str[0]=='b' &&str[1]=='d') ||(str[0]=='l' &&str[1]=='l')|| (str[0]=='d' &&str[1]=='b') || (str[0]=='o' &&str[1]=='o') || (str[0]=='p' &&str[1]=='q') || (str[0]=='q' &&str[1]=='p') || (str[0]=='v' &&str[1]=='v')||(str[0]=='w' &&str[1]=='w')||(str[0]=='x' &&str[1]=='x')){
                    flag=true;
                }
        ...
        if((str[mid]=='b' &&str[mid-1]=='d') ||(str[mid]=='l' &&str[mid-1]=='l')|| (str[mid]=='d' &&str[mid-1]=='b') || (str[mid]=='o' &&str[mid-1]=='o') || (str[mid]=='p' &&str[mid-1]=='q') || (str[mid]=='q' &&str[mid-1]=='p') || (str[mid]=='v' &&str[mid-1]=='v')||(str[mid]=='w' &&str[mid-1]=='w')||(str[mid]=='x' &&str[mid-1]=='x')){
                    flag=true;
                }
        ...
        if(flag==true){
            ...
            for(int i=0;i<mid-1;i++){
                if((str[i]=='b' &&str[size1-i-1]=='d') ||(str[i]=='l' &&str[size1-i-1]=='l')|| (str[i]=='d' &&str[size1-i-1]=='b') || (str[i]=='o' &&str[size1-i-1]=='o') || (str[i]=='p' &&str[size1-i-1]=='q') || (str[i]=='q' &&str[size1-i-1]=='p') || (str[i]=='v' &&str[size1-i-1]=='v')||(str[i]=='w' &&str[size1-i-1]=='w')||(str[i]=='x' &&str[size1-i-1]=='x')){
                        flag=true;
                    }
        ...
        if(size1==1){
             bool flag=false;
             if((str[0]=='b') ||(str[0]=='l')|| (str[0]=='H')||(str[0]=='d') || (str[0]=='o') || (str[0]=='p' ) || (str[0]=='q') || (str[0]=='v')||(str[0]=='w')||(str[0]=='x')){
                    flag=true;
                }
            ...
            else if((str[mid]=='o')||(str[mid]=='v')||(str[mid]=='w')||(str[mid]=='x')){
                flag=true;
            }
            else{
                flag=false;
            ...
            if(flag==true){
                    bool flag=false,flag1=false;
                    for(int i=0;i<mid;i++){
                        if((str[i]=='b' &&str[size1-i-1]=='d') || (str[i]=='d' &&str[size1-i-1]=='b')|| (str[i]=='o' &&str[size1-i-1]=='o') || (str[i]=='p' &&str[size1-i-1]=='q') || (str[i]=='q' &&str[size1-i-1]=='p') || (str[i]=='v' &&str[size1-i-1]=='v')||(str[i]=='w' &&str[size1-i-1]=='w')||(str[i]=='x' &&str[size1-i-1]=='x')||(str[i]=='l' &&str[size1-i-1]=='l')){
                            flag=true;
                        }
